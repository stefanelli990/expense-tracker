<template>
  ...
  <div v-else class="max-w-5xl mx-auto px-4">
    ...
    <div class="overflow-auto">
      <table class="border-collapse table-auto w-full text-sm text-left bg-white rounded-lg p-4 mb-4 whitespace-nowrap dark:bg-slate-800/50">
      <thead class="">
        <tr class="border-b dark:border-slate-700">
          ...
          <th class="p-4 pl-8 pb-3">Actions</th>
        </tr>
      </thead>
      <tbody>
