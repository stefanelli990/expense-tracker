<template>
    ...
    <div class="fixed top-0 left-0 min-h-screen p-4 z-10 bg-white w-full duration-300 md:hidden" :class="storeTransactions.menuIsVisible ? 'translate-x-0' : '-translate-x-full'">
    ...
    <!-- inputs desktop -->
    <div class="hidden max-w-5xl mx-auto px-4 md:flex space-x-4">
